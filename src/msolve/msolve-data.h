...
typedef struct{
  ...
  mp_limb_t *pts;
  int bw_data; /* is set to 1 if Block-Wiedemann is used */
  int32_t B; /* number of columns of the multiplying matrices in 
                 Block Wiedemann */
  CF_l_t *seq_mat; /* Sequence of matrices produced by Block-Wiedemann
  ...
  CF_t *tres_mat ALIGNED32; /*temporary matrix to store matxxn->dense_part * rand_mat */
} fglm_data_t;
